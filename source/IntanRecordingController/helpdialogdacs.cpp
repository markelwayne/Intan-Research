    ...
    QDialog(parent)
{
    ...
    QLabel *label1 = new QLabel(tr("Up to eight selected amplifier channels may be routed to the "
                                   "Analog Out ports on the Intan Recording Controller.  "
    ...
    QLabel *label2 = new QLabel(tr("The selected amplifier waveforms are routed directly through the hardware on the "
                                   "Intan Recording Controller to avoid delays associated with the USB interface and software.  "
    ...
    QLabel *label4 = new QLabel(tr("The Intan Recording Controller also includes optional 'noise slicer' signal processing that can "
                                   "be used to enhance the audibility of low-amplitude neural spikes in a noisy waveform.  "
                                   "The operation of the noise slicer algorithm is described in the Intan Recording Controller User "
