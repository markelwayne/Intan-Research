    ...
    QDialog(parent)
{
    ...
    QLabel *label1 = new QLabel(tr("The optional <a href=\"http://www.intantech.com/IO_expander.html\">Intan I/O Expander</a> "
                                   "connects to the Intan Recording Controller "
    ...
    QLabel *label2 = new QLabel(tr("The I/O Expander is powered from the Intan Recording Controller over a supplied interface "
