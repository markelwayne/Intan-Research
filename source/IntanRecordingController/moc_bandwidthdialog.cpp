...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_BandwidthDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 60, 6)
    ...
    "\0onDspCheckBoxChanged\0enable\0"
};
...
const QMetaObject BandwidthDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_BandwidthDialog.data,
      qt_meta_data_BandwidthDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BandwidthDialog.stringdata))
