...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_HelpDialogDacs_t, stringdata) + ofs \
...
const QMetaObject HelpDialogDacs::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_HelpDialogDacs.data,
      qt_meta_data_HelpDialogDacs,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HelpDialogDacs.stringdata))
