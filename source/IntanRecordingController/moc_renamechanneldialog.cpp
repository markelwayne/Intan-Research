...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_RenameChannelDialog_t, stringdata) + ofs \
...
const QMetaObject RenameChannelDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_RenameChannelDialog.data,
      qt_meta_data_RenameChannelDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RenameChannelDialog.stringdata))
