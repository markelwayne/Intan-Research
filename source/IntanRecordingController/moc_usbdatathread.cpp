...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_UsbDataThread_t, stringdata) + ofs \
...
const QMetaObject UsbDataThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_UsbDataThread.data,
      qt_meta_data_UsbDataThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UsbDataThread.stringdata))
