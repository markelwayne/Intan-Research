...
unsigned int Rhd2000DataBlockUsb3::calculateDataBlockSizeInWords(int numDataStreams)
{
    return SAMPLES_PER_DATA_BLOCK * (4 + 2 + (numDataStreams * (CHANNELS_PER_STREAM + 3)) + (numDataStreams % 4) + 8 + 2);
