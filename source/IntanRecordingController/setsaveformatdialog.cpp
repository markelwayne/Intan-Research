...
SetSaveFormatDialog::SetSaveFormatDialog(SaveFormat initSaveFormat, bool initSaveTtlOut, int initNewSaveFilePeriodMinutes,
                                         QWidget *parent) :
    QDialog(parent)
{ 
    ...
    QLabel *label2 = new QLabel(tr("This option creates a subdirectory and saves raw data files for each "
                                   "signal type: amplifiers, auxiliary inputs, supply voltages, and controller "
                                   "analog and digital inputs.  For example, the amplifier.dat "
